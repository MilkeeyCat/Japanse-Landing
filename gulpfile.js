...
var path = {
    ...
    src: {
        ...
        videos: "src/assets/videos/**/*.{mp4,avi}",
        music: "src/assets/music/**/*.{mp3,wav}",
...
function watchFiles() {
    ...
    gulp.watch([path.watch.music], music);
    gulp.watch([path.watch.fonts], fonts);
}

const build = gulp.series(clean, gulp.parallel(html, css, js, images, videos, music, fonts));
